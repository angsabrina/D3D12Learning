...
#include <Events.h> // relay window events back to game class

#include <memory> // for std::enable_shared_from_this
#include <string> // for std::wstring

// the Window class is forward-declared in order to avoid including the header file for that class.
class Window;
